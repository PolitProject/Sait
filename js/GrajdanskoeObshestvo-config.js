...
var quizJSON = {
    ...
    "questions": [
        { // Question 1
            "q": "Теорию разделения властей изложил в своих трудах в 17 веке ",
            "a": [
                {"option": "Томас Гоббс", "correct": false},
                {"option": "Шарль Луи Монтескьё", "correct": true},
                {"option": "Роберт Фалмер", "correct": false},
                {"option": "Джордж Вашингтон", "correct": false} // no comma here
            ],
